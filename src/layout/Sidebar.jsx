...
const TOP_GROUPS = [
  {
    ...
    label: "Dashboard",
    roles: ["admin", "partner", "client", "c-admin"],
    items: [
      { key: "overview",        label: "Overview" },
      { key: "reporting",       label: "Reporting", roles: ["admin", "partner", "client", "c-admin"] },
      { key: "traffic-sources", label: "Traffic Sources", roles: ["admin", "partner", "client", "c-admin"] },
    ],
  },
  {
    key: "management",
    ...
    items: [
      ...
      { key: "services", label: "Manage Services", roles: ["admin", "partner", "client", "c-admin"] },
  ...
  },
  {
    ...
    roles: ["admin", "partner", "client", "c-admin"],
    items: [
      { key: "fraud-codes", label: "Fraud Codes", roles: ["admin"] },
